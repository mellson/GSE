...
The two test users was both males, and \textless age\textgreater and \textless age\textgreater years of age, and both worked for a security company where their primary task was to maintain and develop on the company system.
...
The test users was recorded with <insert camera specs here - along with dataformat\textgreater.
...
At this point we created a webpage with the explicit purpose of peer reviewing the video we had collected. The link was sent out to users from the software development community, who then partook in the survey on their own machine and in their own setting.
...
This is to insure that the users participating in the survey are familiar with the environmental setting of software development and also to insure the validity of this paper.

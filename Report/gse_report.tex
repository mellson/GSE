...
%None of the participants we're deemed invalid
%show the demography here
%Show the precisions from the results of the different sets.
%Explain the results are worse than random
%Discuss why that may be
%Explain the "trick" the forgarty's paper uses
%Explain that we use almost the same trick
%Show results before and after trick

\begin{table}[h]
  \begin{tabular}{@{}lll@{}}
    \toprule
    Set     & Original & Adjusted \\ \midrule
    A       & 50.99    & 21.42    \\
    B       & 57.14    & 21.42    \\
    C       & 82.14    & 39.28    \\
    D       & 78.57    & 32.14    \\

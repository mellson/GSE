...
On this webpage the participants were asked to assess interruptibility for the two test persons based on short sequences of video, showing the test persons in random selected situations in their work environment.

\subsubsection{Stage One}
The two test persons was both males, and \textless age\textgreater and \textless age\textgreater years of age.
...
The test persons was recorded with \textless insert camera specs here - along with dataformat\textgreater.
...
At this stage we created a webpage with the explicit purpose of peer reviewing the video we had collected. The link was sent out to persons from the software development community, who then partook in the survey on their own machine and in their own setting.
...
This is to ensure that the persons participating in the survey are familiar with the environmental setting of software development and also to ensure the validity of this paper.

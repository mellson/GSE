...
The central component of Approximator is the infrastructure. The infrastructure is a server component that is deployed to a cloud service. 
It is based on the actor model by Carl Hewitt \cite{hewitt1973universal} to make highly scalable. 

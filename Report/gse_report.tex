...
In order to account for this we use the same scale conversion as Fogarty.
...
The Adjusted column in \autoref{tab:survey_accuracy} shows the accuracy of the answers where values have been changed as described above.

As discussed previously in \nameref{stage_two} the demography of the participants in the survey may impact the interpreted interruptibility of other people. \autoref{fig:demography_country} shows the distribution of participants by country of origin, \autoref{fig:demography_age} shows by age and \autoref{fig:demography_gender} shows by gender.

...
\begin{figure}[H]
  ...
  \caption{Infrastructure encapsulated in a communication layer.}
...
%TODO remove list and write about why we think these are sensors.
\begin{itemize}
  \item Keyboard and Mouse
  \item Microphone
  \item Camera
  \item Bluetooth and Wi-Fi
  \item Lightsensor
  \item Process monitor
  \item Geo-location
  \item Calendar Sensor
\end{itemize}
